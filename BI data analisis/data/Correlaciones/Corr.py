...
#df=pd.read_csv(file,header=0,sep=';',encoding=encodings,on_bad_lines='warn')
#region = df['Región']
files=['Region Del Biobio.csv','Region Del Maule.csv',"Region Libertador Bernardo O'Higgins.csv"]
def main():
